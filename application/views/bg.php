  ...
  document.oncontextmenu=new Function("alert(message);return false");
    ...
    <section class="pricing-page">
        <div class="container">
            <div class="center">  
                <h2>Beton Galian</h2>
                <p class="lead" style="text-align:justify"> <font face="BPreplay">Perusahaan mempunyai areal pertambangan batu adhesit seluas 14,5 hektar yang terletak di Desa Sumber Suko, Pasuruan, Jawa Timur.
                Produk yang dihasilkan yaitu :
                - Batu pecah mesin berbagai ukuran
                - Base Coarse</font><p>

                <p class="lead" style="text-align:justify"> <font face="BPreplay">Produk ini sebagian besar diserap para kontraktor dan produsen lainnya untuk mendukung kegiatan proyek sarana/prasarana dan sebagian untuk kebutuhan sendiri.
                Sebagai salah satu unsur bahan baku utama dari produk beton, maka pengembangan usaha ke daerah lain akan terus diupayakan.</font><p>    
            </div>  
...
<!--                             <li class="heading-one">
                            ...
                            <div class="media">
                                <div class="pull-left">
                                    <a href="#"><img class="media-object" src="<?php echo base_url();?>public/images/produk/bg.jpg" alt=""></a>
                                </div>
                            </div>
                        </ul>
                    </div>
