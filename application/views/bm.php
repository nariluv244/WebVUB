<script type="text/javascript">
  ...
  document.oncontextmenu=new Function("alert(message);return false");
    ...
    <section class="pricing-page">
        <div class="container">
            <div class="center">  
                <h2>Beton Masonry (BM)</h2>
                <p class="lead">Berikut beberapa produk yang kami hasilkan dari Unit Bisnis Beton Masonry (BM)</p>
            </div>  
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 plan price-one wow fadeInDown">
                        <ul>
                            <div class="media">
                                <div class="pull-left">
                                    <a href="#"><img class="media-object" src="<?php echo base_url();?>public/images/produk/masonry.png" alt=""></a>
                                </div>
                            </div>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-8 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <div class="media">
                                <div class="pull-left">
                                    <a href="#"><img class="media-object" src="<?php echo base_url();?>public/images/produk/beton-ringan-barang.png" alt=""></a>
                                </div>
                            </div>
                        </ul>
                    </div>
