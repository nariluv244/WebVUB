            ...
            <div class="row">
                <div class="portfolio-items">
                    ...
                    <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                     ...
                     <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url();?>public/images/clients/koinpratama.png" alt="">
                        </div>
                    </div>                    
                     <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url();?>public/images/clients/rekind.png" alt="">
                        </div>
                    </div>                                        
                     <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url();?>public/images/clients/sasmito.png" alt="">
                        </div>
                    </div>                                                            
                     <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url();?>public/images/clients/sbpi.png" alt="">
                        </div>
                    </div>                                                                                
                     <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url();?>public/images/clients/swa.png" alt="">
                        </div>
                    </div>                                                                                                   
                     <div class="portfolio-item cont col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url();?>public/images/clients/wira-jatim-group.png" alt="">
                        </div>
                    </div>                                                                                                                        
                </div>
            </div>
